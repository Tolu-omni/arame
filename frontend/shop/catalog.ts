...
export const categoryFilters: Record<string, Filter[]> = {
  "All Products": [
    ...
    { title: "Price", defaultOpen: false, type: "range", min: "NGN 50", max: "NGN 165" },
    { title: "Concentration", defaultOpen: false, type: "options", options: ["Eau de Parfum", "Eau de Toilette"] },
  ...
  "Men's Perfumes": [
    ...
    { title: "Price", defaultOpen: true, type: "range", min: "NGN 80", max: "NGN 150" },
    { title: "Concentration", defaultOpen: true, type: "options", options: ["Eau de Parfum", "Eau de Toilette"] },
    { title: "Scent", defaultOpen: false, type: "options", options: ["Jasmine", "Lavender", "Rosehip", "Sandalwood", "Vanilla"] },
    { title: "Scent Profile", defaultOpen: false, type: "options", options: ["Jasmine", "Rose"] },
  ...
  "Body Oils": [
    { title: "Product type", defaultOpen: true, type: "options", options: ["All Products"] },
    { title: "Price", defaultOpen: true, type: "range", min: "NGN 50", max: "NGN 60" },
    { title: "Concentration", defaultOpen: false, type: "options", options: ["Eau de Parfum", "Eau de Toilette"] },
